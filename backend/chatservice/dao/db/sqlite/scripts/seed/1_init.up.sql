INSERT INTO shared_models_metadata (id, name, url, provider, input_token_cost, output_token_cost,progress,is_downloaded,is_downloadable,status,filestore_id,is_embedding_model,capabilities,cached_token_cost,is_enabled,model_info,creator_name,modified_by,description)
  ...
  ('gemini-3-flash-preview', 'gemini-3-flash-preview', 'https://generativelanguage.googleapis.com/v1beta/chat/completions', 'gemini', 0.30, 2.50,'',FALSE,FALSE,0,NULL,FALSE,'{"text":{"input":true,"output":true},"audio":{"input":true,"output":false},"video":{"input":true,"output":false},"image":{"input":true,"output":false},"realtime":false}',0.075,TRUE,'{}','Google','','Next-generation Flash model with enhanced multimodal capabilities'),
  ('gemini-3-pro-preview', 'gemini-3-pro-preview', 'https://generativelanguage.googleapis.com/v1beta/chat/completions', 'gemini', 1.50, 10.00,'',FALSE,FALSE,0,NULL,FALSE,'{"text":{"input":true,"output":true},"audio":{"input":true,"output":false},"video":{"input":true,"output":false},"image":{"input":true,"output":false},"realtime":false}',0.31,TRUE,'{}','Google','','Next-generation Pro model with advanced reasoning capabilities'),
  ...
  ('nomic-embed-text-v1.5-GGUF', 'Nomic Embed Text v1.5','https://huggingface.co/nomic-ai/nomic-embed-text-v1.5-GGUF/resolve/main/nomic-embed-text-v1.5.Q8_0.gguf', 'local', 0.00, 0.00,'',FALSE,TRUE,0,NULL,TRUE,'',0.00,TRUE,'{"download_size":"548 MB","homepage_url":"https://huggingface.co/nomic-ai/nomic-embed-text-v1.5-GGUF","quantization":"Q8_0"}','Nomic AI','','High-performance text embedding model with long context'),
  ...
  ('functiongemma-270m-it-GGUF','Function Gemma 270m Instruct', 'https://huggingface.co/ggml-org/functiongemma-270m-it-GGUF/resolve/main/functiongemma-270m-it-q8_0.gguf', 'local', 0, 0,'',FALSE,TRUE,0,NULL,FALSE,'{}',0.00,TRUE,'{"download_size":"279 MB","homepage_url":"https://huggingface.co/ggml-org/functiongemma-270m-it-GGUF","quantization":"Q8_0"}','Google','ggml-org','Function-calling model for tool use and API interactions'),
  ...
  ('Devstral-Small-2-24B-Instruct-GGUF', 'Devstral Small 2 24B Instruct', 'https://huggingface.co/unsloth/Devstral-Small-2-24B-Instruct-2512-GGUF/resolve/main/Devstral-Small-2-24B-Instruct-2512-Q4_0.gguf', 'local', 0.00, 0.00, '', FALSE, TRUE, 0, NULL, FALSE, '{}', 0.00, TRUE, '{"download_size":"13.6 GB","homepage_url":"https://huggingface.co/unsloth/Devstral-Small-2-24B-Instruct-2512-GGUF","quantization":"Q4_0"}','Mistral AI','Unsloth','Coding agent model for software engineering with 128K context'),
  ('granite-4.0-h-tiny-GGUF', 'IBM Granite 4.0 H Tiny', 'https://huggingface.co/unsloth/granite-4.0-h-tiny-GGUF/resolve/main/granite-4.0-h-tiny-Q8_0.gguf', 'local', 0.00, 0.00, '', FALSE, TRUE, 0, NULL, FALSE, '{}', 0.00, TRUE, '{"download_size":"477 MB","homepage_url":"https://huggingface.co/unsloth/granite-4.0-h-tiny-GGUF","quantization":"Q8_0"}','IBM','Unsloth','Ultra-compact enterprise model for edge deployment')
