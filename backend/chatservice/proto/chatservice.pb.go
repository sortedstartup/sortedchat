...
const file_chatservice_proto_rawDesc = "" +
	...
	"\n" +
	"project_id\x18\x04 \x01(\tR\tprojectId\"\xb8\x01\n" +
	...
	"\ahistory\x18\x01 \x03(\v2\x17.sortedchat.ChatMessageR\ahistory\"\x99\x01\n" +
...
var file_chatservice_proto_msgTypes = make([]protoimpl.MessageInfo, 39)
var file_chatservice_proto_goTypes = []any{
	...
	(*DocumentReference)(nil),         // 10: sortedchat.DocumentReference
	(*MessageSummary)(nil),            // 11: sortedchat.MessageSummary
	(*GetHistoryRequest)(nil),         // 12: sortedchat.GetHistoryRequest
	(*GetHistoryResponse)(nil),        // 13: sortedchat.GetHistoryResponse
	(*ChatMessage)(nil),               // 14: sortedchat.ChatMessage
	(*GetChatListRequest)(nil),        // 15: sortedchat.GetChatListRequest
	(*GetChatListResponse)(nil),       // 16: sortedchat.GetChatListResponse
	(*ChatInfo)(nil),                  // 17: sortedchat.ChatInfo
	(*ModelListInfo)(nil),             // 18: sortedchat.ModelListInfo
	(*ListModelsRequest)(nil),         // 19: sortedchat.ListModelsRequest
	(*ListModelsResponse)(nil),        // 20: sortedchat.ListModelsResponse
	(*ChatSearchRequest)(nil),         // 21: sortedchat.ChatSearchRequest
	(*SearchResult)(nil),              // 22: sortedchat.SearchResult
	(*ChatSearchResponse)(nil),        // 23: sortedchat.ChatSearchResponse
	(*CreateProjectRequest)(nil),      // 24: sortedchat.CreateProjectRequest
	(*CreateProjectResponse)(nil),     // 25: sortedchat.CreateProjectResponse
	(*GetProjectsRequest)(nil),        // 26: sortedchat.GetProjectsRequest
	(*GetProjectsResponse)(nil),       // 27: sortedchat.GetProjectsResponse
	(*Project)(nil),                   // 28: sortedchat.Project
	(*ListDocumentsRequest)(nil),      // 29: sortedchat.ListDocumentsRequest
	(*ListDocumentsResponse)(nil),     // 30: sortedchat.ListDocumentsResponse
	(*Document)(nil),                  // 31: sortedchat.Document
	(*GenerateEmbeddingRequest)(nil),  // 32: sortedchat.GenerateEmbeddingRequest
	(*GenerateEmbeddingResponse)(nil), // 33: sortedchat.GenerateEmbeddingResponse
	(*GenerateChatNameRequest)(nil),   // 34: sortedchat.GenerateChatNameRequest
	(*GenerateChatNameResponse)(nil),  // 35: sortedchat.GenerateChatNameResponse
	(*BranchAChatRequest)(nil),        // 36: sortedchat.BranchAChatRequest
	(*BranchAChatResponse)(nil),       // 37: sortedchat.BranchAChatResponse
	(*ListChatBranchRequest)(nil),     // 38: sortedchat.ListChatBranchRequest
	(*ListChatBranchResponse)(nil),    // 39: sortedchat.ListChatBranchResponse
}
var file_chatservice_proto_depIdxs = []int32{
	...
	11, // 2: sortedchat.ChatResponse.summary:type_name -> sortedchat.MessageSummary
	10, // 3: sortedchat.ChatResponse.document_reference:type_name -> sortedchat.DocumentReference
	14, // 4: sortedchat.GetHistoryResponse.history:type_name -> sortedchat.ChatMessage
	10, // 5: sortedchat.ChatMessage.references:type_name -> sortedchat.DocumentReference
	17, // 6: sortedchat.GetChatListResponse.chats:type_name -> sortedchat.ChatInfo
	18, // 7: sortedchat.ListModelsResponse.models:type_name -> sortedchat.ModelListInfo
	22, // 8: sortedchat.ChatSearchResponse.results:type_name -> sortedchat.SearchResult
	28, // 9: sortedchat.GetProjectsResponse.projects:type_name -> sortedchat.Project
	31, // 10: sortedchat.ListDocumentsResponse.documents:type_name -> sortedchat.Document
	0,  // 11: sortedchat.Document.embedding_status:type_name -> sortedchat.Embedding_Status
	17, // 12: sortedchat.ListChatBranchResponse.branch_chat_list:type_name -> sortedchat.ChatInfo
	8,  // 13: sortedchat.SortedChat.Chat:input_type -> sortedchat.ChatRequest
	34, // 14: sortedchat.SortedChat.GenerateChatName:input_type -> sortedchat.GenerateChatNameRequest
	12, // 15: sortedchat.SortedChat.GetHistory:input_type -> sortedchat.GetHistoryRequest
	15, // 16: sortedchat.SortedChat.GetChatList:input_type -> sortedchat.GetChatListRequest
	6,  // 17: sortedchat.SortedChat.CreateChat:input_type -> sortedchat.CreateChatRequest
	19, // 18: sortedchat.SortedChat.ListModel:input_type -> sortedchat.ListModelsRequest
	21, // 19: sortedchat.SortedChat.SearchChat:input_type -> sortedchat.ChatSearchRequest
	24, // 20: sortedchat.SortedChat.CreateProject:input_type -> sortedchat.CreateProjectRequest
	26, // 21: sortedchat.SortedChat.GetProjects:input_type -> sortedchat.GetProjectsRequest
	29, // 22: sortedchat.SortedChat.ListDocuments:input_type -> sortedchat.ListDocumentsRequest
	32, // 23: sortedchat.SortedChat.SubmitGenerateEmbeddingsJob:input_type -> sortedchat.GenerateEmbeddingRequest
	36, // 24: sortedchat.SortedChat.BranchAChat:input_type -> sortedchat.BranchAChatRequest
	38, // 25: sortedchat.SortedChat.ListChatBranch:input_type -> sortedchat.ListChatBranchRequest
	2,  // 26: sortedchat.SettingService.GetSetting:input_type -> sortedchat.GetSettingRequest
	4,  // 27: sortedchat.SettingService.SetSetting:input_type -> sortedchat.SetSettingRequest
	9,  // 28: sortedchat.SortedChat.Chat:output_type -> sortedchat.ChatResponse
	35, // 29: sortedchat.SortedChat.GenerateChatName:output_type -> sortedchat.GenerateChatNameResponse
	13, // 30: sortedchat.SortedChat.GetHistory:output_type -> sortedchat.GetHistoryResponse
	16, // 31: sortedchat.SortedChat.GetChatList:output_type -> sortedchat.GetChatListResponse
	7,  // 32: sortedchat.SortedChat.CreateChat:output_type -> sortedchat.CreateChatResponse
	20, // 33: sortedchat.SortedChat.ListModel:output_type -> sortedchat.ListModelsResponse
	23, // 34: sortedchat.SortedChat.SearchChat:output_type -> sortedchat.ChatSearchResponse
	25, // 35: sortedchat.SortedChat.CreateProject:output_type -> sortedchat.CreateProjectResponse
	27, // 36: sortedchat.SortedChat.GetProjects:output_type -> sortedchat.GetProjectsResponse
	30, // 37: sortedchat.SortedChat.ListDocuments:output_type -> sortedchat.ListDocumentsResponse
	33, // 38: sortedchat.SortedChat.SubmitGenerateEmbeddingsJob:output_type -> sortedchat.GenerateEmbeddingResponse
	37, // 39: sortedchat.SortedChat.BranchAChat:output_type -> sortedchat.BranchAChatResponse
	39, // 40: sortedchat.SortedChat.ListChatBranch:output_type -> sortedchat.ListChatBranchResponse
	3,  // 41: sortedchat.SettingService.GetSetting:output_type -> sortedchat.GetSettingResponse
	5,  // 42: sortedchat.SettingService.SetSetting:output_type -> sortedchat.SetSettingResponse
...
func file_chatservice_proto_init() {
	...
	file_chatservice_proto_msgTypes[8].OneofWrappers = []any{
