...
type DAO interface {
	...
	AddChatMessageWithTokens(userID string, chatId string, role string, content string, contentImage string, model string, inputTokens int, outputTokens int, cachedTokens int, searchCost float64, references string, ragEnabled bool) (MessageSummary, error)
