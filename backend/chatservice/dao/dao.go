...
type DAO interface {
	...
	AddChatMessageWithContent(userID string, chatId string, role string, content string, contentJSON string, model string, inputTokens int, outputTokens int, cachedTokens int, references string, ragEnabled bool) (string, error)
