...
func (x *ModelInfo) GetCreatorName() string {
	if x != nil {
...
const file_inferenceservice_proto_rawDesc = "" +
	...
	"\x05speed\x18\x04 \x01(\x03R\x05speed\"\x91\x04\n" +
	"\x05Model\x12\x0e\n" +
	...
	"\n" +
	"is_enabled\x18\x0e \x01(\bR\tisEnabled\x124\n" +
	"\n" +
	"model_info\x18\x0f \x01(\v2\x15.sortedchat.ModelInfoR\tmodelInfo\"\x9b\x01\n" +
	"\tModelInfo\x12!\n" +
	"\fcreator_name\x18\x01 \x01(\tR\vcreatorName\x12\"\n" +
	"\rhome_page_url\x18\x02 \x01(\tR\vhomePageUrl\x12\"\n" +
	"\fquantization\x18\x03 \x01(\tR\fquantization\x12#\n" +
	"\rdownload_size\x18\x04 \x01(\tR\fdownloadSize\"5\n" +
