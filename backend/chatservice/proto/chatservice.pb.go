...
func (x *ChatResponse) GetDocumentReference() *DocumentReference {
	if x != nil {
...
type ChatResponse_DocumentReference struct {
	DocumentReference *DocumentReference `protobuf:"bytes,3,opt,name=document_reference,json=documentReference,proto3,oneof"`
}
...
type DocumentReference struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	DocsId        string                 `protobuf:"bytes,1,opt,name=docs_id,json=docsId,proto3" json:"docs_id,omitempty"`
...
func (x *DocumentReference) GetDocsId() string {
	if x != nil {
		return x.DocsId
	}
	return ""
...
func (x *DocumentReference) GetFileName() string {
	if x != nil {
		return x.FileName
	}
	return ""
...
func (x *DocumentReference) GetChunkText() string {
	if x != nil {
		return x.ChunkText
	}
	return ""
...
func (x *DocumentReference) GetStartByte() int32 {
	if x != nil {
		return x.StartByte
	}
	return 0
...
func (x *DocumentReference) GetEndByte() int32 {
	if x != nil {
		return x.EndByte
	}
	return 0
...
type ChatMessage struct {
	...
	References    []*DocumentReference   `protobuf:"bytes,4,rep,name=references,proto3" json:"references,omitempty"`
...
func (x *ChatMessage) GetReferences() []*DocumentReference {
	if x != nil {
		return x.References
	}
	return nil
...
type ChatInfo struct {
	...
	RagEnabled    bool                   `protobuf:"varint,3,opt,name=rag_enabled,json=ragEnabled,proto3" json:"rag_enabled,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ChatInfo) GetRagEnabled() bool {
	if x != nil {
		return x.RagEnabled
	}
	return false
...
const file_chatservice_proto_rawDesc = "" +
	...
	"\x0fproject_context\x18\x04 \x01(\v2\x1a.sortedchat.ProjectContextR\x0eprojectContext\"\xb8\x01\n" +
	"\fChatResponse\x12\x14\n" +
	"\x04text\x18\x01 \x01(\tH\x00R\x04text\x126\n" +
	"\asummary\x18\x02 \x01(\v2\x1a.sortedchat.MessageSummaryH\x00R\asummary\x12N\n" +
	"\x12document_reference\x18\x03 \x01(\v2\x1d.sortedchat.DocumentReferenceH\x00R\x11documentReferenceB\n" +
	"\n" +
	"\bresponse\"\xa2\x01\n" +
	"\x11DocumentReference\x12\x17\n" +
	"\adocs_id\x18\x01 \x01(\tR\x06docsId\x12\x1b\n" +
	...
	"\bend_byte\x18\x05 \x01(\x05R\aendByte\"/\n" +
	...
	"\ahistory\x18\x01 \x03(\v2\x17.sortedchat.ChatMessageR\ahistory\"\xba\x01\n" +
	...
	"\n" +
	"references\x18\x04 \x03(\v2\x1d.sortedchat.DocumentReferenceR\n" +
	"references\x12\x1f\n" +
	...
	"\x05chats\x18\x01 \x03(\v2\x14.sortedchat.ChatInfoR\x05chats\"W\n" +
	"\bChatInfo\x12\x16\n" +
	"\x06chatId\x18\x01 \x01(\tR\x06chatId\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x1f\n" +
	"\vrag_enabled\x18\x03 \x01(\bR\n" +
	"ragEnabled\"\xb9\x01\n" +
	...
	"\x0eSTATUS_SUCCESS\x10\x032\xbc\b\n" +
	"\n" +
	"SortedChat\x12;\n" +
...
var file_chatservice_proto_msgTypes = make([]protoimpl.MessageInfo, 40)
var file_chatservice_proto_goTypes = []any{
	...
	(*ProjectContext)(nil),            // 8: sortedchat.ProjectContext
	(*ChatRequest)(nil),               // 9: sortedchat.ChatRequest
	(*ChatResponse)(nil),              // 10: sortedchat.ChatResponse
	(*DocumentReference)(nil),         // 11: sortedchat.DocumentReference
	(*MessageSummary)(nil),            // 12: sortedchat.MessageSummary
	(*GetHistoryRequest)(nil),         // 13: sortedchat.GetHistoryRequest
	(*GetHistoryResponse)(nil),        // 14: sortedchat.GetHistoryResponse
	(*ChatMessage)(nil),               // 15: sortedchat.ChatMessage
	(*GetChatListRequest)(nil),        // 16: sortedchat.GetChatListRequest
	(*GetChatListResponse)(nil),       // 17: sortedchat.GetChatListResponse
	(*ChatInfo)(nil),                  // 18: sortedchat.ChatInfo
	(*ModelListInfo)(nil),             // 19: sortedchat.ModelListInfo
	(*ListModelsRequest)(nil),         // 20: sortedchat.ListModelsRequest
	(*ListModelsResponse)(nil),        // 21: sortedchat.ListModelsResponse
	(*ChatSearchRequest)(nil),         // 22: sortedchat.ChatSearchRequest
	(*SearchResult)(nil),              // 23: sortedchat.SearchResult
	(*ChatSearchResponse)(nil),        // 24: sortedchat.ChatSearchResponse
	(*CreateProjectRequest)(nil),      // 25: sortedchat.CreateProjectRequest
	(*CreateProjectResponse)(nil),     // 26: sortedchat.CreateProjectResponse
	(*GetProjectsRequest)(nil),        // 27: sortedchat.GetProjectsRequest
	(*GetProjectsResponse)(nil),       // 28: sortedchat.GetProjectsResponse
	(*Project)(nil),                   // 29: sortedchat.Project
	(*ListDocumentsRequest)(nil),      // 30: sortedchat.ListDocumentsRequest
	(*ListDocumentsResponse)(nil),     // 31: sortedchat.ListDocumentsResponse
	(*Document)(nil),                  // 32: sortedchat.Document
	(*GenerateEmbeddingRequest)(nil),  // 33: sortedchat.GenerateEmbeddingRequest
	(*GenerateEmbeddingResponse)(nil), // 34: sortedchat.GenerateEmbeddingResponse
	(*GenerateChatNameRequest)(nil),   // 35: sortedchat.GenerateChatNameRequest
	(*GenerateChatNameResponse)(nil),  // 36: sortedchat.GenerateChatNameResponse
	(*BranchAChatRequest)(nil),        // 37: sortedchat.BranchAChatRequest
	(*BranchAChatResponse)(nil),       // 38: sortedchat.BranchAChatResponse
	(*ListChatBranchRequest)(nil),     // 39: sortedchat.ListChatBranchRequest
	(*ListChatBranchResponse)(nil),    // 40: sortedchat.ListChatBranchResponse
}
var file_chatservice_proto_depIdxs = []int32{
	...
	8,  // 2: sortedchat.ChatRequest.project_context:type_name -> sortedchat.ProjectContext
	12, // 3: sortedchat.ChatResponse.summary:type_name -> sortedchat.MessageSummary
	11, // 4: sortedchat.ChatResponse.document_reference:type_name -> sortedchat.DocumentReference
	15, // 5: sortedchat.GetHistoryResponse.history:type_name -> sortedchat.ChatMessage
	11, // 6: sortedchat.ChatMessage.references:type_name -> sortedchat.DocumentReference
	18, // 7: sortedchat.GetChatListResponse.chats:type_name -> sortedchat.ChatInfo
	19, // 8: sortedchat.ListModelsResponse.models:type_name -> sortedchat.ModelListInfo
	23, // 9: sortedchat.ChatSearchResponse.results:type_name -> sortedchat.SearchResult
	29, // 10: sortedchat.GetProjectsResponse.projects:type_name -> sortedchat.Project
	32, // 11: sortedchat.ListDocumentsResponse.documents:type_name -> sortedchat.Document
	0,  // 12: sortedchat.Document.embedding_status:type_name -> sortedchat.Embedding_Status
	18, // 13: sortedchat.ListChatBranchResponse.branch_chat_list:type_name -> sortedchat.ChatInfo
	9,  // 14: sortedchat.SortedChat.Chat:input_type -> sortedchat.ChatRequest
	35, // 15: sortedchat.SortedChat.GenerateChatName:input_type -> sortedchat.GenerateChatNameRequest
	13, // 16: sortedchat.SortedChat.GetHistory:input_type -> sortedchat.GetHistoryRequest
	16, // 17: sortedchat.SortedChat.GetChatList:input_type -> sortedchat.GetChatListRequest
	6,  // 18: sortedchat.SortedChat.CreateChat:input_type -> sortedchat.CreateChatRequest
	20, // 19: sortedchat.SortedChat.ListModel:input_type -> sortedchat.ListModelsRequest
	22, // 20: sortedchat.SortedChat.SearchChat:input_type -> sortedchat.ChatSearchRequest
	25, // 21: sortedchat.SortedChat.CreateProject:input_type -> sortedchat.CreateProjectRequest
	27, // 22: sortedchat.SortedChat.GetProjects:input_type -> sortedchat.GetProjectsRequest
	30, // 23: sortedchat.SortedChat.ListDocuments:input_type -> sortedchat.ListDocumentsRequest
	33, // 24: sortedchat.SortedChat.SubmitGenerateEmbeddingsJob:input_type -> sortedchat.GenerateEmbeddingRequest
	37, // 25: sortedchat.SortedChat.BranchAChat:input_type -> sortedchat.BranchAChatRequest
	39, // 26: sortedchat.SortedChat.ListChatBranch:input_type -> sortedchat.ListChatBranchRequest
	2,  // 27: sortedchat.SettingService.GetSetting:input_type -> sortedchat.GetSettingRequest
	4,  // 28: sortedchat.SettingService.SetSetting:input_type -> sortedchat.SetSettingRequest
	10, // 29: sortedchat.SortedChat.Chat:output_type -> sortedchat.ChatResponse
	36, // 30: sortedchat.SortedChat.GenerateChatName:output_type -> sortedchat.GenerateChatNameResponse
	14, // 31: sortedchat.SortedChat.GetHistory:output_type -> sortedchat.GetHistoryResponse
	17, // 32: sortedchat.SortedChat.GetChatList:output_type -> sortedchat.GetChatListResponse
	7,  // 33: sortedchat.SortedChat.CreateChat:output_type -> sortedchat.CreateChatResponse
	21, // 34: sortedchat.SortedChat.ListModel:output_type -> sortedchat.ListModelsResponse
	24, // 35: sortedchat.SortedChat.SearchChat:output_type -> sortedchat.ChatSearchResponse
	26, // 36: sortedchat.SortedChat.CreateProject:output_type -> sortedchat.CreateProjectResponse
	28, // 37: sortedchat.SortedChat.GetProjects:output_type -> sortedchat.GetProjectsResponse
	31, // 38: sortedchat.SortedChat.ListDocuments:output_type -> sortedchat.ListDocumentsResponse
	34, // 39: sortedchat.SortedChat.SubmitGenerateEmbeddingsJob:output_type -> sortedchat.GenerateEmbeddingResponse
	38, // 40: sortedchat.SortedChat.BranchAChat:output_type -> sortedchat.BranchAChatResponse
	40, // 41: sortedchat.SortedChat.ListChatBranch:output_type -> sortedchat.ListChatBranchResponse
	3,  // 42: sortedchat.SettingService.GetSetting:output_type -> sortedchat.GetSettingResponse
	5,  // 43: sortedchat.SettingService.SetSetting:output_type -> sortedchat.SetSettingResponse
...
func file_chatservice_proto_init() {
	...
	file_chatservice_proto_msgTypes[9].OneofWrappers = []any{
