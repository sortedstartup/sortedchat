...
func (x *ArchiveChatResponse) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
func (x *GetChatListRequest) GetArchived() bool {
	if x != nil {
		return x.Archived
	}
	return false
...
const file_chatservice_proto_rawDesc = "" +
	...
	"\x0eSTATUS_SUCCESS\x10\x032\xd3\n" +
	"\n" +
	"\n" +
	"SortedChat\x12;\n" +
	...
	"\x0eListChatBranch\x12!.sortedchat.ListChatBranchRequest\x1a\".sortedchat.ListChatBranchResponse\x12N\n" +
	"\vArchiveChat\x12\x1e.sortedchat.ArchiveChatRequest\x1a\x1f.sortedchat.ArchiveChatResponse2\xaa\x01\n" +
...
var file_chatservice_proto_msgTypes = make([]protoimpl.MessageInfo, 49)
var file_chatservice_proto_goTypes = []any{
	(Embedding_Status)(0),                           // 0: sortedchat.Embedding_Status
	(*ArchiveChatRequest)(nil),                      // 1: sortedchat.ArchiveChatRequest
	(*ArchiveChatResponse)(nil),                     // 2: sortedchat.ArchiveChatResponse
	(*DeleteDocumentRequest)(nil),                   // 3: sortedchat.DeleteDocumentRequest
	(*DeleteDocumentResponse)(nil),                  // 4: sortedchat.DeleteDocumentResponse
	(*RAGDocumentReferenceRequest)(nil),             // 5: sortedchat.RAGDocumentReferenceRequest
	(*RAGDocumentReferenceResponse)(nil),            // 6: sortedchat.RAGDocumentReferenceResponse
	(*Settings)(nil),                                // 7: sortedchat.Settings
	(*GetSettingRequest)(nil),                       // 8: sortedchat.GetSettingRequest
	(*GetSettingResponse)(nil),                      // 9: sortedchat.GetSettingResponse
	(*SetSettingRequest)(nil),                       // 10: sortedchat.SetSettingRequest
	(*SetSettingResponse)(nil),                      // 11: sortedchat.SetSettingResponse
	(*CreateChatRequest)(nil),                       // 12: sortedchat.CreateChatRequest
	(*CreateChatResponse)(nil),                      // 13: sortedchat.CreateChatResponse
	(*ProjectContext)(nil),                          // 14: sortedchat.ProjectContext
	(*ChatRequest)(nil),                             // 15: sortedchat.ChatRequest
	(*ChatResponse)(nil),                            // 16: sortedchat.ChatResponse
...
var file_chatservice_proto_depIdxs = []int32{
	...
	7,  // 1: sortedchat.GetSettingResponse.settings:type_name -> sortedchat.Settings
	7,  // 2: sortedchat.SetSettingRequest.settings:type_name -> sortedchat.Settings
	14, // 3: sortedchat.ChatRequest.project_context:type_name -> sortedchat.ProjectContext
	...
	48, // 6: sortedchat.RAGDocumentReferenceSummaryList.summary:type_name -> sortedchat.RAGDocumentReferenceSummaryList.Summary
	49, // 7: sortedchat.RAGDocumentReference.Chunks:type_name -> sortedchat.RAGDocumentReference.Chunk
	22, // 8: sortedchat.GetHistoryResponse.history:type_name -> sortedchat.ChatMessage
	18, // 9: sortedchat.ChatMessage.references:type_name -> sortedchat.RAGDocumentReference
	25, // 10: sortedchat.GetChatListResponse.chats:type_name -> sortedchat.ChatInfo
	26, // 11: sortedchat.ListModelsResponse.models:type_name -> sortedchat.ModelListInfo
	30, // 12: sortedchat.ChatSearchResponse.results:type_name -> sortedchat.SearchResult
	36, // 13: sortedchat.GetProjectsResponse.projects:type_name -> sortedchat.Project
	39, // 14: sortedchat.ListDocumentsResponse.documents:type_name -> sortedchat.Document
	0,  // 15: sortedchat.Document.embedding_status:type_name -> sortedchat.Embedding_Status
	25, // 16: sortedchat.ListChatBranchResponse.branch_chat_list:type_name -> sortedchat.ChatInfo
	15, // 17: sortedchat.SortedChat.Chat:input_type -> sortedchat.ChatRequest
	42, // 18: sortedchat.SortedChat.GenerateChatName:input_type -> sortedchat.GenerateChatNameRequest
	20, // 19: sortedchat.SortedChat.GetHistory:input_type -> sortedchat.GetHistoryRequest
	23, // 20: sortedchat.SortedChat.GetChatList:input_type -> sortedchat.GetChatListRequest
	12, // 21: sortedchat.SortedChat.CreateChat:input_type -> sortedchat.CreateChatRequest
	27, // 22: sortedchat.SortedChat.ListModel:input_type -> sortedchat.ListModelsRequest
	29, // 23: sortedchat.SortedChat.SearchChat:input_type -> sortedchat.ChatSearchRequest
	5,  // 24: sortedchat.SortedChat.GetRAGDocumentReference:input_type -> sortedchat.RAGDocumentReferenceRequest
	3,  // 25: sortedchat.SortedChat.DeleteDocument:input_type -> sortedchat.DeleteDocumentRequest
	32, // 26: sortedchat.SortedChat.CreateProject:input_type -> sortedchat.CreateProjectRequest
	34, // 27: sortedchat.SortedChat.GetProjects:input_type -> sortedchat.GetProjectsRequest
	37, // 28: sortedchat.SortedChat.ListDocuments:input_type -> sortedchat.ListDocumentsRequest
	40, // 29: sortedchat.SortedChat.SubmitGenerateEmbeddingsJob:input_type -> sortedchat.GenerateEmbeddingRequest
	44, // 30: sortedchat.SortedChat.BranchAChat:input_type -> sortedchat.BranchAChatRequest
	46, // 31: sortedchat.SortedChat.ListChatBranch:input_type -> sortedchat.ListChatBranchRequest
	1,  // 32: sortedchat.SortedChat.ArchiveChat:input_type -> sortedchat.ArchiveChatRequest
	8,  // 33: sortedchat.SettingService.GetSetting:input_type -> sortedchat.GetSettingRequest
	10, // 34: sortedchat.SettingService.SetSetting:input_type -> sortedchat.SetSettingRequest
	16, // 35: sortedchat.SortedChat.Chat:output_type -> sortedchat.ChatResponse
	43, // 36: sortedchat.SortedChat.GenerateChatName:output_type -> sortedchat.GenerateChatNameResponse
	21, // 37: sortedchat.SortedChat.GetHistory:output_type -> sortedchat.GetHistoryResponse
	24, // 38: sortedchat.SortedChat.GetChatList:output_type -> sortedchat.GetChatListResponse
	13, // 39: sortedchat.SortedChat.CreateChat:output_type -> sortedchat.CreateChatResponse
	28, // 40: sortedchat.SortedChat.ListModel:output_type -> sortedchat.ListModelsResponse
	31, // 41: sortedchat.SortedChat.SearchChat:output_type -> sortedchat.ChatSearchResponse
	6,  // 42: sortedchat.SortedChat.GetRAGDocumentReference:output_type -> sortedchat.RAGDocumentReferenceResponse
	4,  // 43: sortedchat.SortedChat.DeleteDocument:output_type -> sortedchat.DeleteDocumentResponse
	33, // 44: sortedchat.SortedChat.CreateProject:output_type -> sortedchat.CreateProjectResponse
	35, // 45: sortedchat.SortedChat.GetProjects:output_type -> sortedchat.GetProjectsResponse
	38, // 46: sortedchat.SortedChat.ListDocuments:output_type -> sortedchat.ListDocumentsResponse
	41, // 47: sortedchat.SortedChat.SubmitGenerateEmbeddingsJob:output_type -> sortedchat.GenerateEmbeddingResponse
	45, // 48: sortedchat.SortedChat.BranchAChat:output_type -> sortedchat.BranchAChatResponse
	47, // 49: sortedchat.SortedChat.ListChatBranch:output_type -> sortedchat.ListChatBranchResponse
	2,  // 50: sortedchat.SortedChat.ArchiveChat:output_type -> sortedchat.ArchiveChatResponse
	9,  // 51: sortedchat.SettingService.GetSetting:output_type -> sortedchat.GetSettingResponse
	11, // 52: sortedchat.SettingService.SetSetting:output_type -> sortedchat.SetSettingResponse
...
func file_chatservice_proto_init() {
	...
	file_chatservice_proto_msgTypes[15].OneofWrappers = []any{
