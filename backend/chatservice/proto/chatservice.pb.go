...
func (*RAGDocumentReferenceSummaryList_Summary) Descriptor() ([]byte, []int) {
	return file_chatservice_proto_rawDescGZIP(), []int{11, 0}
}
...
const file_chatservice_proto_rawDesc = "" +
	...
	"\n" +
	"project_id\x18\x04 \x01(\tR\tprojectId\"\xc6\x01\n" +
	...
	"\ahistory\x18\x01 \x03(\v2\x17.sortedchat.ChatMessageR\ahistory\"\x9c\x01\n" +
...
var file_chatservice_proto_msgTypes = make([]protoimpl.MessageInfo, 44)
var file_chatservice_proto_goTypes = []any{
	...
	(*ChatRequest)(nil),                             // 10: sortedchat.ChatRequest
	(*ChatResponse)(nil),                            // 11: sortedchat.ChatResponse
	(*RAGDocumentReferenceSummaryList)(nil),         // 12: sortedchat.RAGDocumentReferenceSummaryList
	(*RAGDocumentReference)(nil),                    // 13: sortedchat.RAGDocumentReference
	(*MessageSummary)(nil),                          // 14: sortedchat.MessageSummary
	(*GetHistoryRequest)(nil),                       // 15: sortedchat.GetHistoryRequest
	(*GetHistoryResponse)(nil),                      // 16: sortedchat.GetHistoryResponse
	(*ChatMessage)(nil),                             // 17: sortedchat.ChatMessage
	(*GetChatListRequest)(nil),                      // 18: sortedchat.GetChatListRequest
	(*GetChatListResponse)(nil),                     // 19: sortedchat.GetChatListResponse
	(*ChatInfo)(nil),                                // 20: sortedchat.ChatInfo
	(*ModelListInfo)(nil),                           // 21: sortedchat.ModelListInfo
	(*ListModelsRequest)(nil),                       // 22: sortedchat.ListModelsRequest
	(*ListModelsResponse)(nil),                      // 23: sortedchat.ListModelsResponse
	(*ChatSearchRequest)(nil),                       // 24: sortedchat.ChatSearchRequest
	(*SearchResult)(nil),                            // 25: sortedchat.SearchResult
	(*ChatSearchResponse)(nil),                      // 26: sortedchat.ChatSearchResponse
	(*CreateProjectRequest)(nil),                    // 27: sortedchat.CreateProjectRequest
	(*CreateProjectResponse)(nil),                   // 28: sortedchat.CreateProjectResponse
	(*GetProjectsRequest)(nil),                      // 29: sortedchat.GetProjectsRequest
	(*GetProjectsResponse)(nil),                     // 30: sortedchat.GetProjectsResponse
	(*Project)(nil),                                 // 31: sortedchat.Project
	(*ListDocumentsRequest)(nil),                    // 32: sortedchat.ListDocumentsRequest
	(*ListDocumentsResponse)(nil),                   // 33: sortedchat.ListDocumentsResponse
	(*Document)(nil),                                // 34: sortedchat.Document
	(*GenerateEmbeddingRequest)(nil),                // 35: sortedchat.GenerateEmbeddingRequest
	(*GenerateEmbeddingResponse)(nil),               // 36: sortedchat.GenerateEmbeddingResponse
	(*GenerateChatNameRequest)(nil),                 // 37: sortedchat.GenerateChatNameRequest
	(*GenerateChatNameResponse)(nil),                // 38: sortedchat.GenerateChatNameResponse
	(*BranchAChatRequest)(nil),                      // 39: sortedchat.BranchAChatRequest
	(*BranchAChatResponse)(nil),                     // 40: sortedchat.BranchAChatResponse
	(*ListChatBranchRequest)(nil),                   // 41: sortedchat.ListChatBranchRequest
	(*ListChatBranchResponse)(nil),                  // 42: sortedchat.ListChatBranchResponse
	(*RAGDocumentReferenceSummaryList_Summary)(nil), // 43: sortedchat.RAGDocumentReferenceSummaryList.Summary
	(*RAGDocumentReference_Chunk)(nil),              // 44: sortedchat.RAGDocumentReference.Chunk
}
var file_chatservice_proto_depIdxs = []int32{
	13, // 0: sortedchat.RAGDocumentReferenceResponse.reference:type_name -> sortedchat.RAGDocumentReference
	...
	14, // 3: sortedchat.ChatResponse.summary:type_name -> sortedchat.MessageSummary
	12, // 4: sortedchat.ChatResponse.document_reference:type_name -> sortedchat.RAGDocumentReferenceSummaryList
	43, // 5: sortedchat.RAGDocumentReferenceSummaryList.summary:type_name -> sortedchat.RAGDocumentReferenceSummaryList.Summary
	44, // 6: sortedchat.RAGDocumentReference.Chunks:type_name -> sortedchat.RAGDocumentReference.Chunk
	17, // 7: sortedchat.GetHistoryResponse.history:type_name -> sortedchat.ChatMessage
	13, // 8: sortedchat.ChatMessage.references:type_name -> sortedchat.RAGDocumentReference
	20, // 9: sortedchat.GetChatListResponse.chats:type_name -> sortedchat.ChatInfo
	21, // 10: sortedchat.ListModelsResponse.models:type_name -> sortedchat.ModelListInfo
	25, // 11: sortedchat.ChatSearchResponse.results:type_name -> sortedchat.SearchResult
	31, // 12: sortedchat.GetProjectsResponse.projects:type_name -> sortedchat.Project
	34, // 13: sortedchat.ListDocumentsResponse.documents:type_name -> sortedchat.Document
	0,  // 14: sortedchat.Document.embedding_status:type_name -> sortedchat.Embedding_Status
	20, // 15: sortedchat.ListChatBranchResponse.branch_chat_list:type_name -> sortedchat.ChatInfo
	10, // 16: sortedchat.SortedChat.Chat:input_type -> sortedchat.ChatRequest
	37, // 17: sortedchat.SortedChat.GenerateChatName:input_type -> sortedchat.GenerateChatNameRequest
	15, // 18: sortedchat.SortedChat.GetHistory:input_type -> sortedchat.GetHistoryRequest
	18, // 19: sortedchat.SortedChat.GetChatList:input_type -> sortedchat.GetChatListRequest
	8,  // 20: sortedchat.SortedChat.CreateChat:input_type -> sortedchat.CreateChatRequest
	22, // 21: sortedchat.SortedChat.ListModel:input_type -> sortedchat.ListModelsRequest
	24, // 22: sortedchat.SortedChat.SearchChat:input_type -> sortedchat.ChatSearchRequest
	1,  // 23: sortedchat.SortedChat.GetRAGDocumentReference:input_type -> sortedchat.RAGDocumentReferenceRequest
	27, // 24: sortedchat.SortedChat.CreateProject:input_type -> sortedchat.CreateProjectRequest
	29, // 25: sortedchat.SortedChat.GetProjects:input_type -> sortedchat.GetProjectsRequest
	32, // 26: sortedchat.SortedChat.ListDocuments:input_type -> sortedchat.ListDocumentsRequest
	35, // 27: sortedchat.SortedChat.SubmitGenerateEmbeddingsJob:input_type -> sortedchat.GenerateEmbeddingRequest
	39, // 28: sortedchat.SortedChat.BranchAChat:input_type -> sortedchat.BranchAChatRequest
	41, // 29: sortedchat.SortedChat.ListChatBranch:input_type -> sortedchat.ListChatBranchRequest
	4,  // 30: sortedchat.SettingService.GetSetting:input_type -> sortedchat.GetSettingRequest
	6,  // 31: sortedchat.SettingService.SetSetting:input_type -> sortedchat.SetSettingRequest
	11, // 32: sortedchat.SortedChat.Chat:output_type -> sortedchat.ChatResponse
	38, // 33: sortedchat.SortedChat.GenerateChatName:output_type -> sortedchat.GenerateChatNameResponse
	16, // 34: sortedchat.SortedChat.GetHistory:output_type -> sortedchat.GetHistoryResponse
	19, // 35: sortedchat.SortedChat.GetChatList:output_type -> sortedchat.GetChatListResponse
	9,  // 36: sortedchat.SortedChat.CreateChat:output_type -> sortedchat.CreateChatResponse
	23, // 37: sortedchat.SortedChat.ListModel:output_type -> sortedchat.ListModelsResponse
	26, // 38: sortedchat.SortedChat.SearchChat:output_type -> sortedchat.ChatSearchResponse
	2,  // 39: sortedchat.SortedChat.GetRAGDocumentReference:output_type -> sortedchat.RAGDocumentReferenceResponse
	28, // 40: sortedchat.SortedChat.CreateProject:output_type -> sortedchat.CreateProjectResponse
	30, // 41: sortedchat.SortedChat.GetProjects:output_type -> sortedchat.GetProjectsResponse
	33, // 42: sortedchat.SortedChat.ListDocuments:output_type -> sortedchat.ListDocumentsResponse
	36, // 43: sortedchat.SortedChat.SubmitGenerateEmbeddingsJob:output_type -> sortedchat.GenerateEmbeddingResponse
	40, // 44: sortedchat.SortedChat.BranchAChat:output_type -> sortedchat.BranchAChatResponse
	42, // 45: sortedchat.SortedChat.ListChatBranch:output_type -> sortedchat.ListChatBranchResponse
	5,  // 46: sortedchat.SettingService.GetSetting:output_type -> sortedchat.GetSettingResponse
	7,  // 47: sortedchat.SettingService.SetSetting:output_type -> sortedchat.SetSettingResponse
...
func file_chatservice_proto_init() {
	...
	file_chatservice_proto_msgTypes[10].OneofWrappers = []any{
