...
const (
	...
	SortedChat_DummyTest_FullMethodName     = "/sortedchat.SortedChat/DummyTest"
)
...
type SortedChatClient interface {
	...
	DummyTest(ctx context.Context, in *DummyTestRequest, opts ...grpc.CallOption) (*DummyTestResponse, error)
}
...
func (c *sortedChatClient) DummyTest(ctx context.Context, in *DummyTestRequest, opts ...grpc.CallOption) (*DummyTestResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DummyTestResponse)
	err := c.cc.Invoke(ctx, SortedChat_DummyTest_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SortedChatServer interface {
	...
	DummyTest(context.Context, *DummyTestRequest) (*DummyTestResponse, error)
...
func (UnimplementedSortedChatServer) DummyTest(context.Context, *DummyTestRequest) (*DummyTestResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DummyTest not implemented")
}
...
func _SortedChat_DummyTest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DummyTestRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SortedChatServer).DummyTest(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SortedChat_DummyTest_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SortedChatServer).DummyTest(ctx, req.(*DummyTestRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SortedChat_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DummyTest",
			Handler:    _SortedChat_DummyTest_Handler,
		},
	},
