...
const (
	...
	SortedChat_RetrieveSimilarChunks_FullMethodName = "/sortedchat.SortedChat/RetrieveSimilarChunks"
)
...
type SortedChatClient interface {
	...
	RetrieveSimilarChunks(ctx context.Context, in *RetrieveSimilarChunksRequest, opts ...grpc.CallOption) (*RetrieveSimilarChunksResponse, error)
}
...
func (c *sortedChatClient) RetrieveSimilarChunks(ctx context.Context, in *RetrieveSimilarChunksRequest, opts ...grpc.CallOption) (*RetrieveSimilarChunksResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RetrieveSimilarChunksResponse)
	err := c.cc.Invoke(ctx, SortedChat_RetrieveSimilarChunks_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SortedChatServer interface {
	...
	RetrieveSimilarChunks(context.Context, *RetrieveSimilarChunksRequest) (*RetrieveSimilarChunksResponse, error)
...
func (UnimplementedSortedChatServer) RetrieveSimilarChunks(context.Context, *RetrieveSimilarChunksRequest) (*RetrieveSimilarChunksResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RetrieveSimilarChunks not implemented")
}
...
func _SortedChat_RetrieveSimilarChunks_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RetrieveSimilarChunksRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SortedChatServer).RetrieveSimilarChunks(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SortedChat_RetrieveSimilarChunks_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SortedChatServer).RetrieveSimilarChunks(ctx, req.(*RetrieveSimilarChunksRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SortedChat_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RetrieveSimilarChunks",
			Handler:    _SortedChat_RetrieveSimilarChunks_Handler,
		},
	},
